        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
            ...
            <div className="space-y-2">
              ...
              <Link
                href="/owner/on-call"
                className="flex items-center gap-3 p-3 rounded-xl hover:bg-red-50 transition-colors text-slate-700 hover:text-red-700"
              >
                ...
                <span className="font-medium text-sm">Εφημερία</span>
              </Link>
