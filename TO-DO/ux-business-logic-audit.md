...
- [x] **A2. "Forgot password?" is a dead link**
...
- [x] **A3. "Remember Me" checkbox does nothing**
...
- [x] **A4. No visible password strength indicator**
...
- [x] **A4b. Auth context detects user type from URL, not from API**
...
- [x] **A4c. Homepage hero search does nothing**
...
- [x] **A4d. Homepage quick tags and service cards are placeholders**
...
- [x] **A4e. "Είσοδος / Εγγραφή Ιατρού" button routes to owner login**
...
- [x] **A4f. Vet public profile doesn't show services/pricing**
...
- [x] **A4g. Invite registration allows changing the email**
...
- [x] **A4h. `/pet-owners` page is completely empty**
...
- [x] **A6. Newly registered vets are invisible to owners**
...
- [x] **A7. Owner can't see vet's working hours during booking**
...
- [x] **A8. No appointment type selection linked to vet services**
  - **File:** `vetly-front/app/owner/(dashboard)/book/page.tsx`
...
- [x] **A9. Booking past dates is possible**
...
- [x] **A10. On-call booking uses teal accent instead of red**
...
- [x] **A11. On-call type is hardcoded to "Emergency"**
...
- [x] **A12. Reschedule doesn't check for vet conflicts (backend)**
...
- [x] **A13. Rescheduled appointment goes back to PENDING**
...
- [x] **A14. No way to view appointment details (expanded view)**
...
- [x] **A15. Pet type only supports Dog/Cat/Other**
...
- [x] **A16. No confirmation when soft-deleting a pet**
  - **File:** `vetly-front/app/owner/(dashboard)/pets/page.tsx`
...
- [x] **A17. Notification toggles don't persist**
...
- [x] **A18. Delete review has no confirmation dialog**
...
- [x] **A19. All review operations silently fail**
...
- [x] **A20. Mark-as-read silently fails**
...
- [x] **A21. "X λεπτά πριν" shows "0 λεπτά πριν" for fresh notifications**
...
- [x] **B1. Approve/Reject appointment silently fails**
...
- [x] **B2. Vet-created appointments skip conflict check**
...
- [x] **B3. No appointment status transition validation**
...
- [x] **B4. Group approve/reject only processes the first appointment**
...
- [x] **B5. Examination dialog may be hard to find**
...
- [x] **B6. Working hours not enforced on booking**
...
- [x] **B7. Invite token has 7-day expiry with no resend option**
...
- [x] **B8. Vet reply to review silently fails**
...
- [x] **B9. Vets can't delete or edit their own replies**
...
- [x] **B10. Analytics page title uses English "Analytics"**
...
- [x] **B11. Pet type labels only map Dog/Cat/Other in analytics**
...
- [x] **C1. Empty catch blocks everywhere**
...
- [x] **C2. No token refresh — users get silently logged out after 24 hours**
...
- [x] **C3. No "Session expired" message**
...
- [x] **C6. Dates not localized consistently**
  - **Files:** Various pages
...
- [x] **C7. No loading skeleton on notifications page**
...
- [x] **D1. Owner can review a vet multiple times**
...
- [x] **D2. Vet rating average could become inaccurate**
  - **File:** `vetly-back/app/services/owner.py`
...
- [x] **D3. No cancellation policy / time limit**
  - **File:** `vetly-back/app/services/owner.py`
...
- [x] **D4. Completed appointments can be cancelled**
  - **File:** `vetly-back/app/services/owner.py`
...
- [x] **D5. No duplicate appointment prevention (same pet, same time)**
...
- [x] **D6. On-call appointments create separate records instead of batch**
...
- [x] **D7. Vaccination reminder crashes on Feb 29 (leap year bug)**
...
- [x] **D8. Active medications don't check end_date**
...
- [x] **D9. Medications pagination breaks with client-side pet filter**
...
- [x] **D10. Available slots timezone mismatch**
...
- [x] **D11. Appointment type displayed in English, not Greek**
...
- [x] **D12. Same-day appointment check is too restrictive**
...
- [x] **D13. Notifications don't link to relevant pages**
...
- [x] **D14. No vet reschedule capability**
...
- [x] **D15. Dismissed reminders can't be recovered**
...
- [x] **E1. Add success toasts after actions**
...
- [x] **E2. Add appointment count badge on sidebar navigation**
